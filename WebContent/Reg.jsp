          ...
          <div class="row align-items-center mt-4">
            <div class="col">
              <input type="text" class="form-control" placeholder="Country">
          					...
          					<table class="form-control" align="center" cellpadding="10" style="margin-top: 25px;">
...
<div class="form-group" class="input_field radio_option" style="margin-top: 25px;">
              <input type="radio" name="radiogroup1" id="rd1">
              <label for="rd1">BCA</label>
              <input type="radio" name="radiogroup1" id="rd2">
              <label for="rd2">BTECH</label>
              <input type="radio" name="radiogroup1" id="rd3">
              <label for="rd3">MCA</label>
              <input type="radio" name="radiogroup1" id="rd4">
              <label for="rd4">MTECH</label>
              </div>
          <div class="row align-items-center mt-4">
            <div class="col">
